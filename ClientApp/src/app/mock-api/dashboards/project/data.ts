...
export const project = {
    ...
    taskDistribution: {
        ...
        labels: ['Stealth', 'SIM 2', 'SIM Max', 'M5'],
        series: {
            'this-week': [55, 34, 30, 17],
    ...
    budgetDistribution: {
        categories: ['Logo Hat', 'Driver', 'Irons', 'Putter', 'Ball'],
        series: [
            {
                name: 'Equipment',
                data: [12, 20, 28, 15, 25],
    ...
    yearlyExpenses: {
        amount: 648813,
        labels: [
            moment().subtract(79, 'days').format('DD MMM') +
                ' - ' +
